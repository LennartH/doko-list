...
const reWonWithDoppelkopf = {
  ...
  builder: RoundData.create().withRePoints(140).withDoppelkopfsBy('re'),
};
const reWonButContraDoppelkopf = {
  name: 're won, but contra got doppelkopf',
  builder: RoundData.create().withRePoints(140).withDoppelkopfsBy('contra'),
};
const reWonButContraDoppelkopfAndCaughtCharlie = {
  name: 're won, but contra got doppelkopf and caught charlie',
  builder: RoundData.create().withRePoints(140).withDoppelkopfsBy('contra').charlyCaughtBy('contra'),
};
const reWonBig = {
  name: 're won big',
...
const contraWonWithCapturedDulle = {
  ...
  builder: RoundData.create().withContraPoints(140).dulleCapturedBy('contra'),
};
const contraWonWithLastTrickByFox = {
  name: 'contra won with last trick by fox',
  builder: RoundData.create().withContraPoints(140).lastTrickWithFoxBy('contra'),
};
const contraWonWithLastTrickByCharly = {
  name: 'contra won with last trick by charly',
  builder: RoundData.create().withContraPoints(140).lastTrickWithCharlyBy('contra'),
};
...
const soloWon = {
  name: 'solo won',
  builder: RoundData.create().solo().withRePoints(140),
};
const soloWonWithDoppelkopf = {
  name: 'solo won with doppelkopf',
  builder: RoundData.create().solo().withRePoints(140).withDoppelkopfsBy('re'),
};
const soloLost = {
  name: 'solo lost',
  builder: RoundData.create().solo().withContraPoints(140),
};
const soloLostButCaughtFox = {
  name: 'solo lost but caught fox',
  builder: RoundData.create().solo().withContraPoints(140).foxCaughtBy('re'),
};
const soloTies = {
  name: 'solo ties',
  builder: RoundData.create().solo().withRePoints(120),
};
const soloTiesWithAnnouncement = {
  name: 'solo ties with announcement',
  builder: RoundData.create().solo().withRePoints(120).withReAnnouncement(),
};

const reWonWithAnnouncementLessThan90 = {
  name: 're won with announcement less than 90',
  builder: RoundData.create().withContraPoints(89).withReAnnouncement({ lessThan: 90 }),
};
const reWonWithAnnouncementSchwarz = {
  name: 're won with schwarz announcement',
  builder: RoundData.create().withContraPoints(0).withReAnnouncement({ lessThan: 0 }),
};
const reWonWithAnnouncementLessThan90AndContraAnnouncement = {
  ...
  builder: RoundData.create().withContraPoints(89).withReAnnouncement({ lessThan: 90 }).withContraAnnouncement(),
};
const reLostWithAnnouncementLessThan90 = {
  name: 're lost with announcement less than 90',
  builder: RoundData.create().withContraPoints(90).withReAnnouncement({ lessThan: 90 }),
};

const reWonInBockround = {
  name: 're won in bockround',
  builder: RoundData.create().bockround().withRePoints(140),
};
const reWonInTripleBockround = {
  name: 're won in third consecutive bockround',
  builder: RoundData.create().withConsecutiveBockrounds(3).withRePoints(140),
};
