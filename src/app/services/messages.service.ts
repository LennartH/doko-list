...
export class MessagesService {
  ...
  constructor() {
    this.messages = {
      ...
      ruleSetExistsError: 'Ein Regelsatz mit diesem Namen existiert bereits.',
      general: 'Allgemeines',
      losingPartyGetsNegatedScore: 'Verlierer bekommen Minuspunkte',
      soloWinsOnTie: 'Solo gewinnt bei Gleichstand',
      behaviour: 'Verhalten',
      losingAnnouncementsGivesScore: 'Verlorene An-/Absagen geben Punkte',
      bonusScoresFor: 'Sonderpunkte für',
      bonusScoresOnSolo: 'Auch bei Solo Spielen',
      bonusScoresOnSoloShort: '(auch bei Solo)',
      bockroundsAfter: 'Bockrunden nach',
      consecutiveBockroundsStack: 'Bockrunden überlappen sich',
      consecutiveBockroundsStackShort: '(die überlappen)',
